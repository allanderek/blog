...
So we got a whole two more teams. So there are twelve teams in total. That will never require a *'load more'* button.  Now any one who follows any kind of motorsport knows that the number of teams typically does not change during a season. It's also pretty constant across seasons, Formula 1 for example has had ten teams for a long time. So the number of teams in Formula-E will very likely never be more than 20, at least not whilst this website is still being used. You could easily just display all the 12 teams *always*, no need for any 'load more' button.
